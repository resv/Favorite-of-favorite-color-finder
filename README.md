...
var name = prompt('What is your name?'); alert('Hi ' +(name) +'!'+ ' Welcome to Adam\'s favorites of favorites color finder!');
...
var result= prompt('Interesting choice that you picked ' +color33_5v11+ '! Ok, how about ' +color33_5v11+ ' vs ' +color22_3v4+ '?!')
var thinking1 = alert('Ok, let me calculate our results.')
var thinking2 = alert('Still thinking very hard... give me a second.')
...
var ending = alert('Now when poeple ask you for your favorite color, you can used your results today or try this again sometime in the future, but for now ' +result+ ' is your faovite color, and you can say that with your chest!')
